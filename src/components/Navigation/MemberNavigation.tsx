...
export default function MemberNavigation({ onLogout }: MemberNavigationProps) {
  ...
  const navigationItems = [
    ...
    { name: "Discover", href: "/member/discover", icon: "🔍" },
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 p-6 border-b" style={{ borderColor: 'var(--border)' }}>
            ...
            <div>
              ...
              <p className="text-xs" style={{ color: 'var(--muted-text)' }}>Member Portal</p>
            </div>
          </div>
          ...
          <div className="p-4 border-t" style={{ borderColor: 'var(--border)' }}>
            <div className="flex items-center gap-3 p-3 rounded-lg mb-3" style={{
              ...
              <div className="w-10 h-10 rounded-full flex items-center justify-center" style={{
                ...
                <span className="font-semibold" style={{ color: 'var(--primary-text)' }}>PS</span>
              </div>
              <div className="flex-1">
                <p className="font-medium text-sm" style={{ color: 'var(--primary-text)' }}>Priya Sharma</p>
                <p className="text-xs" style={{ color: 'var(--muted-text)' }}>Member</p>
              </div>
            </div>
